// "AmbiTape" is a version of Adafruit's "Adalight", adapted to use
// a BlinkyTape for LED output. "Adalight" is a do-it-yourself facsimile
// of the Philips Ambilight concept for desktop computers and home theater PCs.
// This is the host PC-side code written in Processing intended for use
// with a USB-connected BlinkyTape running the standard BlinkyTape firmware.
// You may need to adapt the code and the hardware arrangement for your
// specific display configuration.

// The original source can be found here:
// https://github.com/adafruit/Adalight
// Modifications:
// * Use the BlinkyTape's serial protocol in place of Adafruit's LEDstream
// * Use a denser mapping with LEDs across the top and draping down the sides
//   of the screen.

// Screen capture adapted from code by Cedrik Kiefer (processing.org forum)

// --------------------------------------------------------------------
//   This file is part of AmbiTape.

//   AmbiTape is free software: you can redistribute it and/or modify
//   it under the terms of the GNU Lesser General Public License as
//   published by the Free Software Foundation, either version 3 of
//   the License, or (at your option) any later version.

//   AmbiTape is distributed in the hope that it will be useful,
//   but WITHOUT ANY WARRANTY; without even the implied warranty of
//   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
//   GNU Lesser General Public License for more details.

//   You should have received a copy of the GNU Lesser General Public
//   License along with AmbiTape.  If not, see
...
void setup() {
  ...
  for(i=0; i<leds.length; i++) { // For each LED...
    ...
    if(d == -1) continue; // Skip this pixel
...
void draw () {
  ...
  for(i=0; i<leds.length; i++) {  // For each LED...
    ...
    // Clamp LED colors to 254, since 255 is used for signaling
    ledColor[i][0] = (short)min(ledColor[i][0], (short)254);
    ledColor[i][1] = (short)min(ledColor[i][1], (short)254);
